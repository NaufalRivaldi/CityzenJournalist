	...
	<div class="row" style="padding-top: 60px;">
		...
		<div class="col-md-10">
			<div class="well well-sm">
				Data Konten / Tampil Konten Acc
			</div>
			<h2><span class="glyphicon glyphicon-list-alt"></span> Tampil Data Konten</h2><br>
		</div>
		<div class="col-md-1"></div>
	</div>
						...
						<?php
							...
							if(!isset($_POST["Search"])){
								...
								SELECT be.IdBerita,
									...
									WHERE WHERE be.Pengesahan = 'OK' AND be.Judul LIKE '%$cari%' OR be.Keterangan LIKE '%$cari%' LIMIT $mulai, $halaman");
							}
