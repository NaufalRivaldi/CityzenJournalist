<?php 
	...
	//simpan data berita
	$query = mysqli_query($koneksi, "INSERT INTO tbberita VALUES('','$Judul','$Keterangan',NOW(),'OK','1')");
	if($query){
		//uploud gambar
		...
		echo "<script>alert('Input Data Gagal');location.href='tampilKontenAcc.php'</script>";
	}
?>